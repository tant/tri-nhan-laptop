			...
			<div className="p-6">
				<div className="flex justify-between items-center mb-6">
					<div>
						...
						<p className="text-muted-foreground">Quản lý sản phẩm bán (laptop cũ, linh kiện)</p>
					</div>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
					<div className="bg-card p-6 rounded-lg border">
						...
						<p className="text-muted-foreground mb-4">Quản lý laptop cũ có sẵn để bán</p>
					...
					<div className="bg-card p-6 rounded-lg border">
						...
						<p className="text-muted-foreground mb-4">Quản lý linh kiện có sẵn để bán</p>
						<div className="text-center py-8">
							<p className="text-sm text-muted-foreground">Tính năng đang phát triển</p>
						</div>
					</div>

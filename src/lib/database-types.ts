...
export type NewRepairTicket = Database["public"]["Tables"]["repair_tickets"]["Insert"];
...
export type UpdateRepairTicket = Database["public"]["Tables"]["repair_tickets"]["Update"];
...
export type RepairStatus = Database["public"]["Tables"]["repair_tickets"]["Row"]["status"];
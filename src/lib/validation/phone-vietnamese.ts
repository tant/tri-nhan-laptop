...
const VIETNAMESE_LANDLINE_PREFIXES = [
  '024', '028', // Hanoi, Ho Chi Minh City
  '0203', '0204', '0205', '0206', '0207', '0208', '0209', // Regional codes
  '0213', '0214', '0215', '0216', '0218', '0220', '0221',
  '0222', '0225', '0226', '0227', '0228', '0229', '0232',
  '0233', '0234', '0235', '0236', '0237', '0238', '0239',
  '0251', '0252', '0254', '0255', '0256', '0258', '0259',
  '0260', '0261', '0262', '0263', '0269', '0270', '0271',
  '0272', '0273', '0274', '0275', '0276', '0277', '0290',
  '0291', '0292', '0293', '0294', '0296', '0297', '0299'
];
...
function getCarrierName(phone: string): string | undefined {
  ...
  for (const [carrier, prefixes] of Object.entries(VIETNAMESE_MOBILE_PREFIXES)) {
 ...
 */
export function searchPhoneNumbers(query: string, phoneNumbers: string[]): string[] {

...
export function ServiceHistoryDisplay({
	customerPhone,
	onClose,
}: ServiceHistoryDisplayProps) {
	...
	const { getServiceHistory, getVietnameseStatus, formatCurrency } =
		useCustomerPortal();
	...
	const getStatusBadge = (status: string) => {
		...
		return (
			statusMap[status] || { variant: "outline" as const, icon: AlertCircle }
		);
	};

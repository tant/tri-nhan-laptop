...
import { X, Star, Heart, CheckCircle, AlertCircle } from "lucide-react";
...
export function FeedbackDialog({ repairId, customerPhone, onClose, onSubmitSuccess }: FeedbackDialogProps) {

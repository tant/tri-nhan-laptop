...
import { AlertTriangle, CheckCircle, Clock, Info, ArrowRight, History } from 'lucide-react';
import { useRepairWorkflow, WorkflowTicket, StateChangeLog } from '@/hooks/use-repair-workflow';
...
export function WorkflowStatus({ ticket, userRole, userId, onStateChange }: WorkflowStatusProps) {
  const {
    getWorkflowProgress,
    getNextStates,
    changeTicketState,
  ...
  const [selectedNewState, setSelectedNewState] = useState<RepairState | null>(null);
  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {nextStates.length > 0 && (
                <Dialog open={showStateChange} onOpenChange={setShowStateChange}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Chuyển trạng thái phiếu sửa chữa</DialogTitle>
                      <DialogDescription>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setSelectedNewState(value as RepairState)}
                        >
                          <SelectTrigger>
                      ...
                      <div className="flex gap-2 justify-end">
                        ...
                        <Button
                          ...
                          disabled={!selectedNewState || !changeReason.trim() || submitting}
                        >
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>Tiến độ</span>
                <span>{progress.currentStep}/{progress.totalSteps} bước</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h4 className="font-medium text-sm text-gray-700 mb-2">Các bước đã hoàn thành</h4>
              ...
              <div>
                <h4 className="font-medium text-sm text-gray-700 mb-2">Các bước tiếp theo</h4>
                <div className="space-y-1">
            ...
            {progress.estimatedCompletion && (
              <div className="bg-blue-50 p-3 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-blue-900">Dự kiến hoàn thành:</span>
      ...
      {nextStates.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Các hành động có thể thực hiện</CardTitle>
            <CardDescription>
                ...
                return (
                  <div
                    ...
                    className={`p-3 border rounded-lg cursor-pointer transition-colors hover:bg-gray-50 ${
                      recommended ? 'border-blue-300 bg-blue-50' : 'border-gray-200'
                    }`}
                    onClick={() => {
                ...
                {stateHistory.map((log, index) => (
                  <div key={log.id} className="flex gap-4">
                    <div className="flex flex-col items-center">
                      <div
                        className="w-3 h-3 rounded-full"
                        style={{ backgroundColor: REPAIR_STATES[log.to_state].color }}
                      />
                    ...
                    <div className="flex-1 pb-4">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-medium">{REPAIR_STATES[log.to_state].label}</span>
                      ...
                      <div className="flex items-center gap-2 mt-2 text-xs text-gray-500">
                        <span>Bởi: {(log as any).users?.full_name || log.changed_by}</span>

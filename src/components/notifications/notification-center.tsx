...
import { useNotifications, type NotificationMessage } from "@/hooks/use-notifications";
          ...
          <CardContent className="p-0">
            {filteredNotifications.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>{showUnreadOnly ? "Không có thông báo chưa đọc" : "Chưa có thông báo"}</p>
              </div>
            ) : (
                      ...
                      <div key={notification.id}>
                        <div
                          className={cn(
                            ...
                            !notification.read && "bg-[#299fce]/5 border-l-4 border-l-[#299fce]"
                          )}
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <div className={cn(
                              ...
                              !notification.read ? "bg-[#299fce]/10" : "bg-muted"
                            )}>
                              <IconComponent
                                className={cn(
                                  "h-4 w-4",
